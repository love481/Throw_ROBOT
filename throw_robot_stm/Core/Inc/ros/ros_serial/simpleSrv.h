#ifndef _ROS_SERVICE_simpleSrv_h
#define _ROS_SERVICE_simpleSrv_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char SIMPLESRV[] = "ros_serial/simpleSrv";

  class simpleSrvRequest : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return SIMPLESRV; };
    virtual const char * getMD5() override { return "36d09b846be0b371c5f190354dd3153e"; };

  };

  class simpleSrvResponse : public ros::Msg
  {
    public:
  ...
  class simpleSrv {
    public:
    typedef simpleSrvRequest Request;
    typedef simpleSrvResponse Response;
  };
